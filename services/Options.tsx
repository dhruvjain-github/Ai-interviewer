export const Coachingclass=[
    ...
    },
    {
        ...
        summeryPrompt: 'As per conversation give feedback to user along with where is improvment space depends in well structure also give score out of 5 on basis of user performance',
        abstract: '/ab2.png'
